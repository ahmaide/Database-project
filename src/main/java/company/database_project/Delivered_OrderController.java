...
public class Delivered_OrderController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        hide();
        for(Map.Entry m : Arranged_Order.dates.entrySet()){
    ...
    public void deleteOrder(ActionEvent e) throws SQLException, ClassNotFoundException {
        ...
        if(Arranged_Order.currentA==null)
            ...
            SQL_connection.deleteDeliveredOrder(true);
            observableList = FXCollections.observableArrayList();
            String s = month_selector.getSelectionModel().getSelectedItem().toString();
            for(Map.Entry m : Arranged_Order.passed_list.entrySet()){
                Arranged_Order o = (Arranged_Order) m.getValue();
                if(Dates.stringMonth(o.getOrder_date()).equals(s)){
    ...
    public void restoreMachine(ActionEvent e) throws SQLException, ClassNotFoundException {
        ...
        if(Arranged_Order.currentA==null)
            ...
            if(warehouse_selector.getValue()==null)
                ...
                SQL_connection.retreaveMachineForOrder(warehouse_selector.getValue(), true);
                observableList = FXCollections.observableArrayList();
                String s = month_selector.getSelectionModel().getSelectedItem().toString();
                for(Map.Entry m : Arranged_Order.passed_list.entrySet()){
                    Arranged_Order o = (Arranged_Order) m.getValue();
