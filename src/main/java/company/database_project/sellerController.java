            ...
            if (!id_text.getText().equals("") && !name_text.getText().equals("") &&
                ...
                if (!Seller.list.containsKey(id_text.getText())) {
                    if (isNumeric(id_text.getText()) && isNumeric(actual_text.getText()) && isNumeric(phone_text.getText())) {
                        if (Integer.parseInt(id_text.getText()) > 0 && Integer.parseInt(actual_text.getText()) > 0 && Integer.parseInt(phone_text.getText()) > 0) {
                    ...
                    error_text.setText("This seller id already exists, try another");
                }
            } else {
